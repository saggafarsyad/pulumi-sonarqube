...
namespace Pulumi.Sonarqube
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Sonarqube.version.txt");
    ...
    internal sealed class SonarqubeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SonarqubeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
