...
type Portfolio struct {
	...
	SelectedProjects PortfolioSelectedProjectArrayOutput `pulumi:"selectedProjects"`
	SelectionMode    pulumi.StringPtrOutput              `pulumi:"selectionMode"`
...
func NewPortfolio(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("sonarqube:index/portfolio:Portfolio", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPortfolio(ctx *pulumi.Context,
	...
	var resource Portfolio
	err := ctx.ReadResource("sonarqube:index/portfolio:Portfolio", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type portfolioState struct {
	...
	// A set of projects to add to the portfolio.
	SelectedProjects []PortfolioSelectedProject `pulumi:"selectedProjects"`
...
type PortfolioState struct {
	...
	// A set of projects to add to the portfolio.
	SelectedProjects PortfolioSelectedProjectArrayInput
	SelectionMode    pulumi.StringPtrInput
...
// Which branch to analyze. If nothing, or ” is specified, the main branch is used.
func (o PortfolioOutput) Branch() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Portfolio) pulumi.StringPtrOutput { return v.Branch }).(pulumi.StringPtrOutput)
}
...
func (o PortfolioOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v *Portfolio) pulumi.StringOutput { return v.Key }).(pulumi.StringOutput)
}
...
func (o PortfolioOutput) Qualifier() pulumi.StringOutput {
	return o.ApplyT(func(v *Portfolio) pulumi.StringOutput { return v.Qualifier }).(pulumi.StringOutput)
}

func (o PortfolioOutput) Regexp() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Portfolio) pulumi.StringPtrOutput { return v.Regexp }).(pulumi.StringPtrOutput)
}

// A set of projects to add to the portfolio.
func (o PortfolioOutput) SelectedProjects() PortfolioSelectedProjectArrayOutput {
	return o.ApplyT(func(v *Portfolio) PortfolioSelectedProjectArrayOutput { return v.SelectedProjects }).(PortfolioSelectedProjectArrayOutput)
}

func (o PortfolioOutput) SelectionMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Portfolio) pulumi.StringPtrOutput { return v.SelectionMode }).(pulumi.StringPtrOutput)
}

func (o PortfolioOutput) Tags() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Portfolio) pulumi.StringArrayOutput { return v.Tags }).(pulumi.StringArrayOutput)
}

func (o PortfolioOutput) Visibility() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Portfolio) pulumi.StringPtrOutput { return v.Visibility }).(pulumi.StringPtrOutput)
}
